    ...
    return (
        <section className="items-center bg-sakura flex flex-col gap-8 justify-center h-screen px-4 lg:px-8 w-full" id="work">
            <div className="items-center flex flex-col gap-4 justify-center text-center w-9/12">
                <h2 className={`text-2xl font-bold lg:text-6xl ${style.timelineTitle}`}>My work</h2>
            </div>
            <div className="flex flex-col md:grid md:grid-cols-4 md:gap-4">
                <article className="bg-white shadow-xl rounded-md overflow-hidden">
                    ...
                    <section className="flex flex-col gap-4 p-4">
                        <span className="text-2xs tracking-cardCategory">WordPress</span>
                        <h3 className="text-2xl">Awaken Brand</h3>
                        <a className="items-center bg-kamenozoki text-black text-xs rounded-md flex gap-2 py-1 px-2 w-fit" href="https://www.awakenbrnd.store" target="_blank" rel="nofollow noopener noreferrer">
                            Visit
                ...
                <div className="items-center flex justify-center p-8">
                    Soon more...
                </div>
            </div>
        </section>
